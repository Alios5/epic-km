...
const fr = {
  ...
  "rsm.trimHint": "Si la visée dérive alors que la souris est immobile : augmentez le pitch si elle monte, diminuez-le si elle descend (1 pas ≈ 0,06 °/s).",
    "rsm.restAccel": "Gravité au repos (accéléromètre)",
    "rsm.restAccelNegY": "−Y (convention DS4 réelle)",
    "rsm.restAccelPosY": "+Y (inversée)",
    "rsm.restAccelNegZ": "−Z",
    "rsm.restAccelPosZ": "+Z",
...
const en: Record<MessageKey, string> = {
  ...
  "rsm.trimHint": "If the aim still drifts while the mouse is still: raise pitch if it climbs, lower it if it sinks (1 step ≈ 0.06 °/s).",
    "rsm.restAccel": "Rest gravity (accelerometer)",
    "rsm.restAccelNegY": "−Y (real DS4 convention)",
    "rsm.restAccelPosY": "+Y (inverted)",
    "rsm.restAccelNegZ": "−Z",
    "rsm.restAccelPosZ": "+Z",

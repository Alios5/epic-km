...
const fr = {
  ...
  "debug.toggle": "Console de debug",
  "debug.title": "Console de debug",
  "debug.clear": "Effacer",
  "debug.copy": "Copier",
  "debug.close": "Fermer",
  "debug.empty": "En attente d'événements du moteur d'entrée…",
  ...
  "bottombar.controller": "Manette",
  "controller.xbox360": "Xbox 360",
  "controller.ds4": "PS4 (DualShock 4)",
  // Side panels
  "panel.leftTriggers": "Gâchettes gauche",
  "panel.rightTriggers": "Gâchettes droite",
  "panel.faceButtons": "Boutons A/B/X/Y",
  "panel.faceButtonsDs4": "Boutons d'action",
  ...
  "rsm.gyroSensX": "Sensibilité horizontale (yaw)",
  "rsm.gyroSensY": "Sensibilité verticale (pitch)",
  "rsm.gyroSmoothing": "Lissage",
  "rsm.ayLock": "Anti-recalibration (ay)",
  "rsm.recalibDelay": "Recal. naturelle après (s, 0 = jamais)",
    "rsm.dsuEnable": "Serveur de motion DSU (Cemuhook)",
    "rsm.dsuGravity": "Gravité DSU (accéléromètre)",
    "rsm.dsuGravityHint": "L'accéléromètre indique la direction du bas au jeu (correction d'horizon). La dérive est éliminée par deadzone + lissage du gyroscope, pas par ce réglage. Décochez uniquement si le jeu réagit mal à la gravité constante.",
    "rsm.dsuHint": "Mini-serveur DSU : 127.0.0.1:26760 — configurez cette adresse comme source Cemuhook dans l'émulateur.",
  // Key capture input
  ...
  // DualShock 4 button names (shown instead when the DS4 controller type
  // is selected) — internal mapping keys stay the Xbox names.
  "btn.ds4.A": "Croix",
  "btn.ds4.B": "Rond",
  "btn.ds4.X": "Carré",
  "btn.ds4.Y": "Triangle",
  ...
  "btn.ds4.RT": "R2",
  "btn.ds4.Back": "Share",
  "btn.ds4.Start": "Options",
  "btn.ds4.LeftThumb": "L3",
  "btn.ds4.RightThumb": "R3",
  // Stick settings
...
const en: Record<MessageKey, string> = {
  ...
  "debug.copy": "Copy",
  "debug.close": "Close",
  "debug.empty": "Waiting for input engine events…",
  ...
  "panel.faceButtonsDs4": "Face buttons",
  ...
  "rsm.gyroSensX": "Horizontal sensitivity (yaw)",
  "rsm.gyroSensY": "Vertical sensitivity (pitch)",
  "rsm.gyroSmoothing": "Smoothing",
  "rsm.ayLock": "Anti-recalibration (ay)",
  "rsm.recalibDelay": "Natural recalib. after (s, 0 = never)",
    "rsm.dsuEnable": "DSU motion server (Cemuhook)",
    "rsm.dsuGravity": "DSU gravity (accelerometer)",
    "rsm.dsuGravityHint": "The accelerometer tells the game which way is down (horizon correction). Drift is eliminated by the gyro deadzone + smoothing, not this toggle. Uncheck only if the game misbehaves with constant gravity.",
    "rsm.dsuHint": "DSU mini-server: 127.0.0.1:26760 — set this as the Cemuhook source in your emulator.",
